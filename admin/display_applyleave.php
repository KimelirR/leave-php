                    ...
                    <table class="table table-bordered table-striped ">
                        <thead>
                            <tr>
                                ...
                                <th 5%>Leave Type</th>
                                <th 5%>Department</th>
                                <th 10>Description</th>
                                <th 10%>Leave From:</th>
                                <th 10%>Leave To:</th>
                                <th 10%>Applied At</th>
                                <th 10%>Leave Status</th>
                                <th 10%>Update</th>
                        ...
                        <tbody>
                            ...
                            // $query = "SELECT * FROM apply_leave order by applied_at desc" ;
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <!-- sending fetched id -->
                                        <td><a href="update_applyleave.php?leave_id=<?= $row['leave_id']; ?>" class="btn btn-success">Update</a></td>
...
<script>
    function update_leave_status(leave_id,select_value){
        window.location.href='update_applyleave.php?leave_id='+leave_id+'&type=update&status='+select_value;
